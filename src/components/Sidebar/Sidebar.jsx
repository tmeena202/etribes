...
const Sidebar = () => {
  ...
  return (
    <aside className="w-[220px] h-screen bg-gradient-to-b from-[#1a4d3a]/90 via-[#174c3a]/95 to-[#1a4d3a]/90 text-white p-3 flex flex-col fixed top-0 left-0 border-r border-[#2d6b4f] z-[1000] overflow-y-auto transition-all duration-350 backdrop-blur-md shadow-2xl scrollbar-none">
